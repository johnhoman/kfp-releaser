...
/* DeletePipelineVersionOK describes a response with status code 200, with default header values.
...
/* DeletePipelineVersionDefault describes a response with status code -1, with default header values.
...
func (o *DeletePipelineVersionDefault) GetPayload() *models.APIStatus {
	return o.Payload
}
