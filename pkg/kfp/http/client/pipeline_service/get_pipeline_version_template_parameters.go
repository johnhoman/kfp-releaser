...
/* GetPipelineVersionTemplateParams contains all the parameters to send to the API endpoint
   for the get pipeline version template operation.
...
// WithDefaults hydrates default values in the get pipeline version template params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPipelineVersionTemplateParams) WithDefaults() *GetPipelineVersionTemplateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get pipeline version template params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPipelineVersionTemplateParams) SetDefaults() {
