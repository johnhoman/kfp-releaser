...
/* GetPipelineVersionTemplateOK describes a response with status code 200, with default header values.

A successful response.
*/
type GetPipelineVersionTemplateOK struct {
	Payload *models.APIGetTemplateResponse
}
...
func (o *GetPipelineVersionTemplateOK) GetPayload() *models.APIGetTemplateResponse {
	return o.Payload
}
...
func (o *GetPipelineVersionTemplateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.APIGetTemplateResponse)
...
/* GetPipelineVersionTemplateDefault describes a response with status code -1, with default header values.
...
func (o *GetPipelineVersionTemplateDefault) GetPayload() *models.APIStatus {
	return o.Payload
}
