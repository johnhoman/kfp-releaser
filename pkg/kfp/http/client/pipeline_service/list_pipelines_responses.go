...
func (o *ListPipelinesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.APIListPipelinesResponse)
...
/* ListPipelinesDefault describes a response with status code -1, with default header values.
...
func (o *ListPipelinesDefault) GetPayload() *models.APIStatus {
	return o.Payload
}
