...
/* DeletePipelineVersionParams contains all the parameters to send to the API endpoint
   for the delete pipeline version operation.
...
// WithDefaults hydrates default values in the delete pipeline version params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeletePipelineVersionParams) WithDefaults() *DeletePipelineVersionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete pipeline version params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeletePipelineVersionParams) SetDefaults() {
