...
/* UpdatePipelineDefaultVersionOK describes a response with status code 200, with default header values.
...
/* UpdatePipelineDefaultVersionDefault describes a response with status code -1, with default header values.
...
func (o *UpdatePipelineDefaultVersionDefault) GetPayload() *models.APIStatus {
	return o.Payload
}
